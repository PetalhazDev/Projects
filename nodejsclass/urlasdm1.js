...
const calculatorModule = require("./urlasdm.js")
//change amsd.js to calculatormodule.js
const PORT =8089
...
httpserver.createServer((req,res) =>{
    ...
    console.log(parser)
    res.write(htmlFile);
    if(parser.pathname ==="/calculator/addition"){
        ...
        if(isNaN(number1) || isNaN(number2)){ 
            ...
            const answer = calculatorModule.addition(number1,number2)
